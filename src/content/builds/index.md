...
builds:
  Security & Red/Blue Team:
    - name: Vyrox Security
      ...
      desc: Memory-safe, autonomous AI SOC infrastructure for deterministic threat
        investigation.
      ...
      repo: vyrox
    - name: DeepSentry
      link: https://deepsentry.pages.dev
      desc: Unsupervised Anomaly Detection in System Logs.
      icon: i-ph:code-duotone
      tech:
        - i-logos:python
      repo: keirsalterego/deepsentry
  Open Source Contributions:
    - name: Dora-rs - Metadata::get_or
      link: https://github.com/dora-rs/dora/pull/1400
      desc: Added Metadata::get_or for cleaner parameter access with defaults,
        reducing boilerplate and improving ergonomics in dora-rs.
    ...
    - name: Rust Clippy - useless_conversion lint
      ...
      desc: Enhanced .into_iter() suggestions for nested references, fixing
        over-borrowed code patterns in the official Rust linter.
  ...
  Solana / On-chain:
    - name: Time Capsule Protocol
      ...
      desc: "Trustless time-locking: encrypt now, auto-reveal later-no
        intermediaries."
    ...
    - name: ScholrLink
      ...
      desc: Social articles become one-tap Solana funding portals with Blinks and
  ...
  Systems Tools:
    - name: DedCore
      ...
      desc: A high-performance file deduplication tool with TUI, featuring
        multi-algorithm hashing and smart filtering.
    ...
    - name: RustyTasks
      ...
      desc: Conquer your tasks with ruthless efficiency using this command-line
        powerhouse.
